...
class BloodType(models.Model):
	blood_type = models.ForeignKey(BloodGroup, 'on_delete')
...
class Drug(models.Model):
	...
	form = models.ForeignKey(DrugForm, 'on_delete')
	dispense_type = models.ForeignKey(DrugDispenseType, 'on_delete')
...
class Responder(models.Model):
	...
	gender = models.ForeignKey(Gender, 'on_delete')
	state = models.ForeignKey(State, 'on_delete')
	local_govt = models.ForeignKey(LocalGovernment, 'on_delete')
...
class ClientProfile(models.Model):
	...
	gender = models.ForeignKey(Gender, 'on_delete')
	genotype = models.ForeignKey(Genotype, 'on_delete')
	blood_group = models.ForeignKey(BloodGroup, 'on_delete')
	...
	hmo = models.ForeignKey(HMO, 'on_delete', null=True)
...
class SMSVerification(models.Model):
	user = models.ForeignKey(Member, 'on_delete')
...
class PasswordReset(models.Model):
	client = models.ForeignKey(Member, 'on_delete')
